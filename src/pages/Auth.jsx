  ...
  return (
    <div className="min-h-screen w-full bg-[url('https://wallpaperaccess.com/full/124383.jpg')] bg-cover bg-center">
      <div className="flex min-h-screen items-center justify-center bg-black/40 px-4">
        {/* Login Card */}
        <div className="w-full max-w-md rounded-2xl border border-white/20 bg-gray-900/90 p-8 text-white shadow-2xl backdrop-blur-sm">
          {/* Icon */}
          ...
          {/* Heading */}
          <h1 className="mt-5 text-center text-3xl font-bold">Welcome Back</h1>

          <p className="mt-2 text-center text-sm text-gray-400">
            Login to continue to Book
          ...
          <div className="mt-6 flex justify-center gap-1 text-sm">
            ...
            <p className="cursor-pointer text-amber-400 hover:underline">
              Register Here
            </p>
          </div>
        </div>
